    ...
    return (
        <body>
            ...
            <p>
              ...
              lærer oss om livet og den ubetingede kjærligheten. Vi lærer gjensidig tillit, opplever de vakreste eventyrene og hva det betyr å gi slipp.</p>
            <p>
              ...
              sørge for at vi aldri glemmer dem. Verken hvordan hjertene våre på fire poter så ut, eller deres personlighetstrekk, de felles eventyrene og hva de betyr for oss.</p>
            <p>
        ...
        <div className=" bg-[#CFC8CA] px-4 lg:px-40 flex flex-wrap items-center justify-start">
            ...
            <p className="text-[#21262B]">
              ...
              bare på denne måten ekte og uanstrengte øyeblikk kan oppstå og bli fanget av meg for deg.</p>
            </div>
        </div>
